...
<!--todo: remove script above after conversion to vue 3-->
<script setup>
...
#props-designer-tree .v-expansion-panel--active:not(:first-child), .v-expansion-panel--active + .v-expansion-panel{
  margin-top:0;
}
</style>
