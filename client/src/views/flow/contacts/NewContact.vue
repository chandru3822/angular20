        ...
        <v-container>
          <v-row>
            <v-col cols="12" sm="6">
              <a-select
                attach
                v-model="contact.objectCategoryId"
                class="body-large"
          ...
          <v-row>
            <v-col cols="12" sm="6">
              ...
              <a-select
                attach
                v-model="contact.companyStateId"
                class="body-large"
                :items="states"
                label="State"
                id="qa-state-field"
            ...
            <v-col cols="12" sm="6">
              ...
              <a-select
                attach
                v-model="contact.companyCountryId"
                class="body-large"
                :items="countries"
                label="Country"
                id="qa-country-field"
...
const contactPhoneRule = ref([
  () =>
    (contact.value.phone != null && contact.value.phone !== '') ||
    (contact.value.mobile != null && contact.value.mobile !== '') ||
  ...
  (v) =>
    ...
    'Phone and Mobile Cannot be the same'
])
