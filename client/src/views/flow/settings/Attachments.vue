...
export default {
  ...
  methods: {
    ...
    async addNewType () {
      ...
      const {data} = await postRequest(`/api/v1/flow/companies/${this.companyId}/attachment/type`, this.newType)
    ...
    async saveType (a) {
      ...
      await putRequest(`/api/v1/flow/companies/${this.companyId}/attachment/type`, a)
    }
  },
  async created () {
