    ...
    <v-form>
      <v-container>
        <v-row align="start">
          ...
          <v-col cols="12" sm="6" md="4" v-if="showSalesAreaSelector">
            <v-select
              tabindex=4
              :items="salesAreas"
              item-value="id"
          ...
          <v-col cols="12" sm="6" md="4" v-if="showMetroAreaSelector">
            <v-select
          ...
          <v-col cols="12" sm="6" md="4" v-if="showSalesMetroAreaSelector">
            <v-select
          ...
          <v-col cols="12" sm="6" md="4" v-if="showOriginatorSelector">
            <v-text-field
              label="Originator ID"
          ...
          <v-col cols="12" sm="6" md="4" v-if="showColorPicker">
            <v-input label="Color">
              <v-menu
                top
                offset-y
