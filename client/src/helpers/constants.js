...
constants.WHITELISTED_FILE_EXTENSIONS = ['.png','.jpg','.jpeg','.gif','.tiff','.psd','.raw','.doc','.docx','.pdf','.xls','.xlsx','.xlsm','.dxf','.csv','.txt','.dwg']
...
constants.STANDARD_IMAGES_AND_DOCS = 'image/*, .doc, .docx, .pdf, .xls, .xlsx, .csv, .txt, .xlsm, .dxf, .dwg'
constants.STANDARD_IMAGES_ONLY = 'image/*'
constants.STANDARD_DOCS_ONLY = '.doc, .docx, .pdf, .xls, .xlsx, .csv, .txt, .xlsm'
