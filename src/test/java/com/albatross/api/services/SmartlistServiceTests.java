...
public class SmartlistServiceTests {
  ...
  public void projectDetails() {
    // The array in this query needs to keep update to date with currentlyFailing
    final String query = """
      select s.id
    ...
    smartlistIds.forEach(id -> {
      try {
        ...
        if (!currentlyFailing.contains(id)) {
