...
public class GetTheReferralQuery {
  ...
  public final static String getProjectCreatedMilestoneContacts = """
    select pd.contact_email, pd.contact_id
        from brs.project_details pd
              left join flow.contact_custom_field_value cfv
                        on pd.contact_id = cfv.contact_id and cfv.custom_field_group_assignment_id = 27364
  ...
  public final static String upsertCustomFieldValue = """
    ...
    values (:contactId, :customFieldGroupAssignmentId, :textValue, :userId, now(), :userId, now())
