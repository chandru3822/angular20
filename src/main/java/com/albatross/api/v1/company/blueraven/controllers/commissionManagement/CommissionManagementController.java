...
public class CommissionManagementController {
  ...
  public String saveMilestone(@PathVariable Long planId, @RequestBody Milestone milestone) {
    return commissionManagementService.saveMilestone(planId, milestone);
  }

  @DeleteMapping(value = "/{planId}/milestone/{id}")
  public void removeMilestone(@PathVariable Long planId, @PathVariable Long id) {
    commissionManagementService.removeMilestone(planId, id);
  }

  @PutMapping(value = "/{planId}/milestone")
  public void updateMilestone(@PathVariable Long planId, @RequestBody Milestone milestone) {
  ...
  public List<Payroll> customerSearch(@PathVariable Long userId, @RequestBody String query) {
