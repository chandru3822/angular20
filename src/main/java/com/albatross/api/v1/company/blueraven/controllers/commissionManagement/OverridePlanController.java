...
public class OverridePlanController {
  ...
  public void deleteReceivingUser(@PathVariable Long id, @PathVariable Long userId) {
  ...
  public void deleteAssignedUser(@PathVariable Long id, @PathVariable Long assignedUserId) {
