...
public class PostalCodeQuery {
  ...
  //language=PostgreSQL
  public final static String getZones = """
    select pcz.id,
            pcz.company_id,
            pcz.zone_name,
            pcz.remote,
  ...
  //language=PostgreSQL
  public final static String getZonesForUser = """
    with positions as (
  ...
  //language=PostgreSQL
  public final static String getZoneByPostalCode = """
    select pcz.id,
          company_id,
          zone_name,
          pcz.remote,
  ...
  //language=PostgreSQL
  public final static String getCodesForZone = """
    select pc.id,
  ...
  //language=PostgreSQL
  public final static String getZone = """
    select pcz.id,
               pcz.company_id,
               pcz.distribution_time_frame_days,
               pcz.schedulable_future_days,
  ...
  //language=PostgreSQL
  public final static String insertZone = """
  ...
  //language=PostgreSQL
  public final static String updateZone = """
  ...
  //language=PostgreSQL
  public final static String deleteZone = """
    update flow.postal_code_zone
        set archived = true,
            modified_by_id = :modifiedById,
            date_modified = now()
  ...
  //language=PostgreSQL
  public final static String insertZoneUser = """
  ...
  //language=PostgreSQL
  public final static String updateZoneUser = """
    update flow.postal_code_zone_user
  ...
  //language=PostgreSQL
  public final static String deleteZoneUser = """
    update flow.postal_code_zone_user
        set archived = true,
            modified_by_id = :modifiedById,
            date_modified = now()
  ...
  //language=PostgreSQL
  public final static String getZoneUser = """
    select pczu.id,
  ...
  //language=PostgreSQL
  public final static String updateZoneCode = """
  ...
  //language=PostgreSQL
  public final static String addZoneCode = """
  ...
  //language=PostgreSQL
  public final static String deleteZoneCode = """
    update flow.postal_code_zone_postal_code
       set archived = true,
           modified_by_id = :modifiedById,
           date_modified = now()
  ...
  //language=PostgreSQL
  public final static String getZoneCode = """
    select pc.id,
  ...
  //language=PostgreSQL
  public final static String getAvailableZoneUsers = """
  ...
  //language=PostgreSQL
  public final static String getAllZoneUsers = """
    select pczu.id,
               pczu.user_id,
               u.first_name,
               u.last_name,
  ...
  //language=PostgreSQL
  public final static String getZoneUsersByDownline = """
    select pczu.id,
               pczu.user_id,
               u.first_name,
               u.last_name,
            ...
            exists (
                with positions as (
                  ...
                  from positions p
                         join lateral flow.org_hierarchy_filter_down_search(array [p.parent_org_id]) as t
                              on true)
                select distinct pczu2.postal_code_zone_id
                from org_ids o
                       inner join flow.user_position up on up.org_id = o.id and (up.end_date is null or up.end_date > now()) and up.archived is false
                       inner join flow.postal_code_zone_user pczu2 on pczu2.user_id = up.user_id
                  and pczu2.postal_code_zone_user_type_id = 1
