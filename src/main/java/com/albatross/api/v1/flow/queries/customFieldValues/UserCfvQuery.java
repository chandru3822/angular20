...
public class UserCfvQuery {
  ...
  public final static String getUserProfileFields = """
    select * from flow.get_cfgs_with_values(:objectTypeId::bigint, :sourceId::bigint, null::bigint, :companyId::bigint, false::boolean, null::bigint[], true::boolean, true::boolean);
  """;
