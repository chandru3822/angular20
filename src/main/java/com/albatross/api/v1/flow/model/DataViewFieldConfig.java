...
public class DataViewFieldConfig {
  ...
  private List<Long> parentCfgaIds, parentPsIds, parentPseIds;
  private String fieldToUpdate, fieldName, displayName, columnName, propertyName, parentObjectName, processStepName, processStepEventName, description, parentMenuOption;
