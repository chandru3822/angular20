...
public class ProcessStepAttachmentTypeQuery {

  //language=PostgreSQL
  public final static String getStepTypes = """
    select psat.id,
    ...
    select psat.id,
               ...
               coalesce((
                          ...
                          FROM (
                                 ...
                                 WHERE cfg.process_step_attachment_type_id = psat.id AND cfg.archived is not true
