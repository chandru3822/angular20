...
public class ContactActivityQuery {
  ...
  public final static String addContactActivity = """
      insert into flow.contact_activity(contact_id, date_modified, note, date_created, created_by_id, modified_by_id, archived, activity_type_id, created_by_user_position_id)
