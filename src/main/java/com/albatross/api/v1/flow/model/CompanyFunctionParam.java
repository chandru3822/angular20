...
public class CompanyFunctionParam {
  ...
  private Long id, companyFunctionId, customFieldGroupId, systemValueId, dbFunctionParamId, displayOrder, parameterDataTypeId, processStepId, createdById, modifiedById;
