...
import com.albatross.api.v1.flow.services.propTool.PricingService;
...
@Slf4j
@RestController
@RequestMapping(value = "/api/v1/flow/propTool/pricing")
public class PricingController {
  ...
  public List<Pricing> getPricingsForCompany() {
    return pricingService.getPricingsForCompany();
  }
  ...
  public Optional<Pricing> savePricing(@RequestBody Pricing pricing) {
