  ...
  BEGIN
    ...
    for w in
      select
        ...
        case when ptc.PROJECT_TASK_C_completed_by_c is null and ptc.completed_by_c is not null then
               2495780::bigint
             else
      ...
      loop
        ...
        case
          when w.name = 'Input Promise Dates' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29028, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29053, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Obtain Builder Plot Plan' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29068, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29075, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Complete Design Package' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28980, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28987, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Complete BOM' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28958, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28965, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Preliminary IC Submission w/Utility' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29079, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29086, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Upload Design' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29090, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29097, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Apply for Permit' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28936, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28943, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Designs Distributed' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29021, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29049, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Permit Pickup' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29101, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29108, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Complete Rough Wire' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28991, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29033, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Complete Storage Rough' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29000, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29037, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Obtain Builder WO' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29112, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29119, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Create Material Lines & PO/SO' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29007, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29041, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Preliminary IC Approval' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29123, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29130, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Complete CF-2R in Registry' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28969, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28976, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'System Installation' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29134, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29141, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Installation Checklist Uploaded' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29057, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29064, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Storage Installation' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29145, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29152, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Storage Checklist Completed' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29156, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29163, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Affirm AHJ Inspection Complete' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28913, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28920, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'AHJ Storage Inspection' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28924, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28931, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Closure of RevRec' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28947, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 28954, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Upload Final Building Permit' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29167, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29174, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Invoice Packet Complete and Sent' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29178, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29185, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Obtain HO Utility Information' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29189, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29196, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Submit Documents for PTO' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29200, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29207, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Receive PTO from Utility' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29211, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29218, w.PROJECT_TASK_C_completed_by_c::text, true);
          ...
          when w.name = 'Customer System Activation' then
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29014, w.PROJECT_TASK_C_assigned_to_c::text, true);
            ...
            perform flow.set_pps_cfv_no_checks(v_project_process_step_id, 2384850, 29045, w.PROJECT_TASK_C_completed_by_c::text, true);
