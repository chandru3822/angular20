...
select 'Closer Dashboard Funnel', 'CLOSER_DASHBOARD_FUNNEL', 2384850, 2384850 where not exists (select id from brs.dashboard_milestone_type where dashboard_milestone_code = 'CLOSER_DASHBOARD_FUNNEL');
