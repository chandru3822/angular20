...
update flow.user_feature_access_control set company_feature_id = (select id from flow.company_feature where feature_name = 'AHJ') where company_feature_id = 6;
insert into flow.feature_access_control(feature_id, access_control_id, created_by_id, modified_by_id)
select (select feature_id from flow.company_feature where feature_name = 'HOA'), 1, 2453836, 2453836 where not exists(
...
insert into flow.feature_access_control(feature_id, access_control_id, created_by_id, modified_by_id)
select (select feature_id from flow.company_feature where feature_name = 'HOA'), 2, 2453836, 2453836 where not exists(
...
insert into flow.feature_access_control(feature_id, access_control_id, created_by_id, modified_by_id)
select (select feature_id from flow.company_feature where feature_name = 'HOA'), 3, 2453836, 2453836 where not exists(
...
insert into flow.feature_access_control(feature_id, access_control_id, created_by_id, modified_by_id)
select(select feature_id from flow.company_feature where feature_name = 'HOA'), 4, 2453836, 2453836 where not exists(
...
insert into flow.feature_access_control(feature_id, access_control_id, created_by_id, modified_by_id)
select (select feature_id from flow.company_feature where feature_name = 'Utility'), 1, 2453836, 2453836 where not exists(
...
insert into flow.feature_access_control(feature_id, access_control_id, created_by_id, modified_by_id)
select (select feature_id from flow.company_feature where feature_name = 'Utility'), 2, 2453836, 2453836 where not exists(
...
insert into flow.feature_access_control(feature_id, access_control_id, created_by_id, modified_by_id)
select (select feature_id from flow.company_feature where feature_name = 'Utility'), 3, 2453836, 2453836 where not exists(
...
insert into flow.feature_access_control(feature_id, access_control_id, created_by_id, modified_by_id)
select (select feature_id from flow.company_feature where feature_name = 'Utility'), 4, 2453836, 2453836 where not exists(
