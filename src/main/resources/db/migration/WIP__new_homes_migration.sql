...
$do$
  ...
  BEGIN
    for x in  select q.*,p.id as project_id,
      ...
      inner join flow.project p on p.nw_migration_id = rpc.id
      left join flow.list_of_value lov1 on lov1.name = inverter_brand_c and lov1.parent_id = 25826
      left join flow.list_of_value lov2 on lov2.name = mounting_description_c and lov2.parent_id = 25828
      ...
      left join flow.list_of_value lov6 on lov6.name = and lov6.parent_id =
      left join flow.list_of_value lov7 on lov7.name = and lov7.parent_id =
      left join flow.list_of_value lov8 on lov8.name = and lov8.parent_id =
      ...
      loop
        ...
        --perform flow.set_project_cfv(x.project_id , 2384850,27998,x.community_id_c::text , true);
        ...
        --todo check thisperform flow.set_project_cfv(x.project_id , 2384850,29307,x.apr_type_c::text , true);
        ...
        perform flow.set_project_cfv(x.project_id , 2384850,29323,x.consolidated_lease_number_c::text , true);
