CREATE OR REPLACE FUNCTION flow.set_project_cfv(p_project_id integer, p_user_id integer,p_cfga integer, p_value_to_save text, p_override_existing boolean default true)
    returns boolean AS
$BODY$
declare
...
--         raise notice 'hello world %', v_date_value_to_save;
    ...
    -- 9,System List
            if v_data_type_id = 1 then
                ...
                values (p_project_id, p_cfga, coalesce(v_date_value_to_save::date, p_value_to_save::date), null, null, null, null, null, null, p_user_id, now(), p_user_id, now());
            elsif v_data_type_id = 2 then
                insert into flow.project_custom_field_value(project_id, custom_field_group_assignment_id, date_value, timestamp_value, boolean_value, text_value, numeric_value, int_value, int_array_value, created_by_id, date_created, modified_by_id, date_modified)
                values (p_project_id, p_cfga, null, coalesce(v_date_value_to_save::timestamp, p_value_to_save::timestamp), null, null, null, null, null, p_user_id, now(), p_user_id, now());
            elsif v_data_type_id = 3 then
                insert into flow.project_custom_field_value(project_id, custom_field_group_assignment_id, date_value, timestamp_value, boolean_value, text_value, numeric_value, int_value, int_array_value, created_by_id, date_created, modified_by_id, date_modified)
                values (p_project_id, p_cfga, null, null, p_value_to_save::boolean, null, null, null, null, p_user_id, now(), p_user_id, now());
                ...
                insert into flow.project_custom_field_value(project_id, custom_field_group_assignment_id, date_value, timestamp_value, boolean_value, text_value, numeric_value, int_value, int_array_value, created_by_id, date_created, modified_by_id, date_modified, rich_text_value)
                values (p_project_id, p_cfga, null, null, null, p_value_to_save::text, null,null, null, p_user_id, now(), p_user_id, now(), case when v_data_type_id = 13 then p_value_to_save::text end);
                ...
                insert into flow.project_custom_field_value(project_id, custom_field_group_assignment_id, date_value, timestamp_value, boolean_value, text_value, numeric_value, int_value, int_array_value, created_by_id, date_created, modified_by_id, date_modified)
                values (p_project_id, p_cfga, null, null, null, null, null, null, p_value_to_save::int[], p_user_id, now(), p_user_id, now());
            end if;
        else
