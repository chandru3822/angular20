drop function if exists flow.set_pps_event_cfv_no_checks(p_ppse_id bigint, p_user_id bigint, p_cfga bigint,
                                                         p_value_to_save text, p_override_existing boolean, text);
CREATE OR REPLACE FUNCTION flow.set_pps_event_cfv_no_checks(p_ppse_id bigint, p_user_id bigint, p_cfga bigint,
