drop function if exists flow.set_pps_event_cfv_no_checks(p_ppse_id bigint, p_user_id bigint, p_cfga bigint, p_value_to_save text, p_override_existing boolean, text);
CREATE OR REPLACE FUNCTION flow.set_pps_event_cfv_no_checks(p_ppse_id bigint, p_user_id bigint, p_cfga bigint, p_value_to_save text, p_override_existing boolean default false, p_secondary_value_to_save text default null)
  returns void AS
$BODY$
declare
    ...
    where cfga.id = p_cfga;
      ...
      if v_data_type_id = 1 then
        insert into flow.project_process_step_event_custom_field_value(project_process_step_event_id,
                                                                       ...
                                                                       date_modified)
        values (p_ppse_id, p_cfga,  p_value_to_save::date, null, null, null, null,
        ...
        insert into flow.project_process_step_event_custom_field_value(project_process_step_event_id,
                                                                       ...
                                                                       created_by_id, date_created, modified_by_id,
                                                                       date_modified)
        values (p_ppse_id, p_cfga, null,  p_value_to_save::timestamp, null,
        ...
        insert into flow.project_process_step_event_custom_field_value(project_process_step_event_id,
                                                                       ...
                                                                       created_by_id, date_created, modified_by_id,
                                                                       date_modified)
        values (p_ppse_id, p_cfga, null, null, p_value_to_save::boolean, null, null, null, null, p_user_id, now(),
        ...
        values (p_ppse_id, p_cfga, null, null, null, p_value_to_save::text, null, null, null, p_user_id, now(),
                p_user_id, now(), case when v_data_type_id = 13 then coalesce(p_secondary_value_to_save,p_value_to_save)::text end) on conflict do nothing;
