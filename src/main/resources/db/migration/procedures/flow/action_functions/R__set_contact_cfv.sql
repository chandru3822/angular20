...
CREATE OR REPLACE FUNCTION flow.set_contact_cfv(p_contact_id bigint, p_user_id bigint,p_cfga bigint, p_value_to_save text, p_override_existing boolean default false)
    returns boolean AS
$BODY$
declare
