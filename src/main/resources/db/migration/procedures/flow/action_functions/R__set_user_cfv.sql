...
CREATE OR REPLACE FUNCTION flow.set_user_cfv(p_user_id integer, p_company_id integer, p_current_user_id integer,p_cfga integer, p_value_to_save text, p_override_existing boolean default false)
    returns boolean AS
$BODY$
declare
...
--         raise notice 'hello world %', v_date_value_to_save;
    ...
    --check that the user company id and the cfga company id are the same in case the user screwed it up
    select p_company_id = (select cot.company_id
    ...
    -- 9,System List
            if v_data_type_id = 1 then
                insert into flow.user_custom_field_value(user_id, custom_field_group_assignment_id, date_value, timestamp_value, boolean_value, text_value, numeric_value, int_value, int_array_value, created_by_id, date_created, modified_by_id, date_modified)
                values (p_user_id, p_cfga, coalesce(v_date_value_to_save::date, p_value_to_save::date), null, null, null, null, null, null, p_current_user_id, now(), p_current_user_id, now());
            elsif v_data_type_id = 2 then
                insert into flow.user_custom_field_value(user_id, custom_field_group_assignment_id, date_value, timestamp_value, boolean_value, text_value, numeric_value, int_value, int_array_value, created_by_id, date_created, modified_by_id, date_modified)
                values (p_user_id, p_cfga, null, coalesce(v_date_value_to_save::timestamp, p_value_to_save::timestamp), null, null, null, null, null, p_current_user_id, now(), p_current_user_id, now());
            elsif v_data_type_id = 3 then
                insert into flow.user_custom_field_value(user_id, custom_field_group_assignment_id, date_value, timestamp_value, boolean_value, text_value, numeric_value, int_value, int_array_value, created_by_id, date_created, modified_by_id, date_modified)
                values (p_user_id, p_cfga, null, null, p_value_to_save::boolean, null, null, null, null, p_current_user_id, now(), p_current_user_id, now());
            elsif v_data_type_id = 4 then
                insert into flow.user_custom_field_value(user_id, custom_field_group_assignment_id, date_value, timestamp_value, boolean_value, text_value, numeric_value, int_value, int_array_value, created_by_id, date_created, modified_by_id, date_modified)
                values (p_user_id, p_cfga, null, null, null, null,p_value_to_save::numeric(10,2), null, null, p_current_user_id, now(), p_current_user_id, now());
            elsif v_data_type_id = 5 or v_data_type_id = 13 then
                insert into flow.user_custom_field_value(user_id, custom_field_group_assignment_id, date_value, timestamp_value, boolean_value, text_value, numeric_value, int_value, int_array_value, created_by_id, date_created, modified_by_id, date_modified, rich_text_value)
                values (p_user_id, p_cfga, null, null, null, p_value_to_save::text, null,null, null, p_current_user_id, now(), p_current_user_id, now(), case when v_data_type_id = 13 then p_value_to_save::text end);
            elsif v_data_type_id = 6 or v_data_type_id = 9 then
                insert into flow.user_custom_field_value(user_id, custom_field_group_assignment_id, date_value, timestamp_value, boolean_value, text_value, numeric_value, int_value, int_array_value, created_by_id, date_created, modified_by_id, date_modified)
                values (p_user_id, p_cfga, null, null, null, null, null, p_value_to_save::int, null, p_current_user_id, now(), p_current_user_id, now());
            elsif v_data_type_id = 7 then
                insert into flow.user_custom_field_value(user_id, custom_field_group_assignment_id, date_value, timestamp_value, boolean_value, text_value, numeric_value, int_value, int_array_value, created_by_id, date_created, modified_by_id, date_modified)
                values (p_user_id, p_cfga, null, null, null, null, null, null, p_value_to_save::int[], p_current_user_id, now(), p_current_user_id, now());
            end if;
        else
          ...
          if p_override_existing is true or (v_existing_value is null or v_existing_value = '') then
            if v_data_type_id = 1 then
                update flow.user_custom_field_value
