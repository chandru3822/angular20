drop function if exists flow.prepare_update_data_view_details(p_id bigint,
                                                              p_sql text,
                                                              ...
                                                              p_last_row boolean,
                                                              p_add_where_clause boolean,
                                                              p_where_clause_condition_ids text);
CREATE OR REPLACE FUNCTION flow.prepare_update_data_view_details(p_id bigint,
                                                                 p_sql text,
                                                                 p_field_to_update character varying,
                                                                 p_value text,
                                                                 p_secondary_field_to_update text,
