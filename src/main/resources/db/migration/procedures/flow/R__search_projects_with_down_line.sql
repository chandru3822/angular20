create or replace function flow.search_projects_with_down_line(p_searchterm character varying, p_company_id integer, p_user_id integer, p_is_parent boolean, p_limit integer, p_offset integer, p_company_project_status_type_id integer DEFAULT NULL::integer, p_sort_column character varying DEFAULT NULL::character varying, p_sort_direction character varying DEFAULT NULL::character varying)
