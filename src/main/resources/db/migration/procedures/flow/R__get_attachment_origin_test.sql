-- DROP FUNCTION IF EXISTS flow.get_attachment_origin_test(integer);
CREATE OR REPLACE FUNCTION flow.get_attachment_origin_test(p_attachment_id INTEGER)

RETURNS TABLE(origin_location text, origin_path text) AS
