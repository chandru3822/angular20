CREATE OR REPLACE FUNCTION flow.get_event_work_queue_type_configs(p_process_step_event_id integer)
  RETURNS TABLE(process_step_event_work_queue_type_event_status_type_id integer,
                process_step_event_work_queue_type_id integer,
