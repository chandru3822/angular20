DROP FUNCTION if exists flow.ps_wqt_configuration_change(bigint, bigint);

CREATE OR REPLACE FUNCTION flow.ps_wqt_configuration_change(p_process_step_work_queue_type_id bigint, p_created_by_id bigint)
  RETURNS void as
$$
BEGIN
  with my_data as (
