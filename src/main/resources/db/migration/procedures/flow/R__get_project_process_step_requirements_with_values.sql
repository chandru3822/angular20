...
CREATE OR REPLACE FUNCTION flow.get_project_process_step_requirements_with_values(p_project_process_step_id bigint, p_requirement_ids bigint[])
  ...
  RETURNS TABLE (id bigint, project_id bigint, process_step_requirement_type_id bigint, process_step_id bigint, operator_type_id bigint, requirement_value varchar, custom_field_group_assignment_id bigint,
                 ...
                 process_step_requirement_type varchar, parent_id bigint, custom_value boolean, parent_name varchar, field_name varchar, custom_field_sql_key varchar, custom_field_sql text, custom_field_sql_smartlist text,
