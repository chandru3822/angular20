...
drop function if exists flow.org_hierarchy_filter_down_search(p_org_ids bigint[]);
CREATE OR REPLACE FUNCTION flow.org_hierarchy_filter_down_search(p_org_ids bigint[])
  RETURNS TABLE
          (
            id            bigint,
