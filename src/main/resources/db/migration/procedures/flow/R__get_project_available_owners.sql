-- drop function if exists flow.get_project_available_owners(int, int, bool);

create or replace function flow.get_project_available_owners(p_company_id int, p_parent_company_id int, p_is_parent bool)
