...
BEGIN
    ...
    if v_utility_account_number is not null and v_utility_account_number != '' then
      perform flow.set_pps_cfv(v_project_id, 2384850, 27067, v_utility_account_number::text); --v_utility_account_number
    end if;
    ...
    if v_structural_upgrades is not null and v_structural_upgrades != '' then
      ...
      if v_structural_upgrades_id is not null then
        perform flow.set_pps_cfv(v_project_id, 2384850, 27073, v_structural_upgrades_id::text); --v_structural_upgrades
      end if;
    end if;
    ...
    if v_battery_topic is not null and v_battery_topic != '' then
      ...
      values (v_project_id, now(), v_battery_topic, now(), 2384850, 2384850, false, false, null, false, null, null, null,
              2, 104055)
    ...
    if v_change_order_topic is not null and v_change_order_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_change_order_topic, now(), 2384850, 2384850, false, false, null, false, null, null,
              null, 2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_design_rework_topic is not null and v_design_rework_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_design_rework_topic, now(), 2384850, 2384850, false, false, null, false, null, null,
              null, 2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_electrical_review_topic is not null  and v_electrical_review_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_electrical_review_topic, now(), 2384850, 2384850, false, false, null, false, null,
              null, null, 2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_final_design_topic is not null and v_final_design_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_final_design_topic, now(), 2384850, 2384850, false, false, null, false, null, null,
              null, 2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_hic_topic is not null  and v_hic_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_hic_topic, now(), 2384850, 2384850, false, false, null, false, null, null, null, 2,
              104055)
      returning id into v_project_activity_id;
    ...
    if v_hoa_topic is not null and v_hoa_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_hoa_topic, now(), 2384850, 2384850, false, false, null, false, null, null, null, 2,
              104055)
      returning id into v_project_activity_id;
    ...
    if v_installation_topic is not null and v_installation_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_installation_topic, now(), 2384850, 2384850, false, false, null, false, null, null,
              null, 2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_mpu_topic is not null and v_mpu_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_mpu_topic, now(), 2384850, 2384850, false, false, null, false, null, null, null, 2,
              104055)
      returning id into v_project_activity_id;
    ...
    if v_permit_pack_topic is not null and v_permit_pack_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_permit_pack_topic, now(), 2384850, 2384850, false, false, null, false, null, null,
              null, 2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_permit_rework_topic is not null and v_permit_rework_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_permit_rework_topic, now(), 2384850, 2384850, false, false, null, false, null, null,
              null, 2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_rebate_topic is not null and v_rebate_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_rebate_topic, now(), 2384850, 2384850, false, false, null, false, null, null, null,
              2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_reroof_topic is not null and v_reroof_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_reroof_topic, now(), 2384850, 2384850, false, false, null, false, null, null, null,
              2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_site_survey_topic is not null and v_site_survey_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_site_survey_topic, now(), 2384850, 2384850, false, false, null, false, null, null,
              null, 2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_structural_review_topic is not null and v_structural_review_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_structural_review_topic, now(), 2384850, 2384850, false, false, null, false, null,
              null, null, 2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_tree_trimming_or_removal_topic is not null and v_tree_trimming_or_removal_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_tree_trimming_or_removal_topic, now(), 2384850, 2384850, false, false, null, false,
    ...
    if v_utility_bill_verification_topic is not null and v_utility_bill_verification_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_utility_bill_verification_topic, now(), 2384850, 2384850, false, false, null, false,
              null, null, null, 2, 104055)
      returning id into v_project_activity_id;
    ...
    if v_other_topic is not null and v_other_topic != '' then
      insert into flow.project_activity(project_id, date_modified, note, date_created, created_by_id, modified_by_id,
                                        ...
                                        linked_pps_id, date_pinned, linked_ppse_id, activity_type_id,
                                        created_by_user_position_id)
      values (v_project_id, now(), v_other_topic, now(), 2384850, 2384850, false, false, null, false, null, null, null,
              2, 104055)
      returning id into v_project_activity_id;
