...
BEGIN
  ...
  perform flow.migrate_insert_event_custom_field_value(p_event_id,
                                                       19027,
                                                       coalesce(v_inspection_need_reschedule_needed, v_inspection_pending_reschedule_needed),
                                                       null,
                                                       null,
                                                       ...
                                                       coalesce(v_modified_by_id_need_needed, v_modified_by_id_pending_needed), true, v_ahj_inspection_nsc_event_id);
  perform flow.migrate_insert_event_custom_field_value(p_event_id,
                                                       19028,
                                                       coalesce(v_inspection_need_reschedule_reason, v_inspection_pending_reschedule_reason),
                                                       null,
                                                       null,
                                                       ...
                                                       coalesce(v_modified_by_id_need_reason, v_modified_by_id_pending_reason), true, v_ahj_inspection_nsc_event_id);
  perform flow.migrate_insert_event_custom_field_value(p_event_id,
                                                       21609,
                                                       coalesce(v_inspection_need_category, v_inspection_pending_category),
                                                       null,
                                                       null,
                                                       ...
                                                       coalesce(v_modified_by_id_need_cat, v_modified_by_id_pending_cat), true, v_ahj_inspection_nsc_event_id);
