create or replace function flow.search_projects_by_user(p_searchterm character varying, p_company_id integer, p_user_id integer, p_is_parent boolean, p_limit integer DEFAULT NULL::integer, p_offset integer DEFAULT NULL::integer, p_company_project_status_type_id integer DEFAULT NULL::integer, p_sort_column character varying DEFAULT NULL::character varying, p_sort_direction character varying DEFAULT NULL::character varying)
  returns TABLE(id integer, project_name character varying, contact_id integer, date_created timestamp without time zone, street1 character varying, street2 character varying, city character varying, state character varying, state_abbreviation character varying, postalcode character varying, latitude double precision, longitude double precision, status_type_id integer, company_project_status_type_id integer, status_type character varying, project_status_type character varying, process_name character varying, contact jsonb)
  language plpgsql
as
$$
DECLARE
