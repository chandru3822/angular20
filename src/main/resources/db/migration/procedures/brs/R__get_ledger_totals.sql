CREATE OR REPLACE FUNCTION brs.get_ledger_totals(p_payroll_id integer, p_project_ids bigint[],p_ledger_type_id integer)
  RETURNS NUMERIC AS
$BODY$
DECLARE
  v_total numeric;
...
4;"RESIDUAL"*/
      ...
      (
        ...
        WHERE array[pcl.project_id] <@ p_project_ids::integer[]
