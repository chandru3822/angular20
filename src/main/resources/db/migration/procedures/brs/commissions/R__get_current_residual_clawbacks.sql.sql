...
begin
  ...
  return query
    ...
    from brs.project_details pd
           ...
           inner join brs.residual_ledger rl on rl.project_id = pd.project_id and rl.user_id = pd.closer_user_id and
      ...
      and rl.user_id = p_closer_user_id and pd.closer_user_id = p_closer_user_id
           inner join brs.residual r on r.id = rl.residual_id
