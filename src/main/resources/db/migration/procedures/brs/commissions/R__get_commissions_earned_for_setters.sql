drop function if exists brs.get_commissions_earned_for_setters(p_project_ids bigint[],p_period_end date );
CREATE OR REPLACE FUNCTION brs.get_commissions_earned_for_setters(p_project_ids bigint[],p_period_end date )
    RETURNS NUMERIC AS
$BODY$
DECLARE
    v_total numeric;
