                  ...
                  FROM ((SELECT f.project_id AS project_id,
                                ...
                                coalesce(
                                  round(case
                                          ...
                                          when f.commission_strategy in (24102) and (cp.commission_strategy_type_id is null or cp.commission_strategy_type_id = 1)  then
                        ...
                        (SELECT d.project_id AS project_id,
                                ...
                                coalesce(
                                  round(case when pd.cancelled_date is not null then 0::numeric
                                             when d.commission_strategy in (24102) and (cp.commission_strategy_type_id is null or cp.commission_strategy_type_id = 1)  then
