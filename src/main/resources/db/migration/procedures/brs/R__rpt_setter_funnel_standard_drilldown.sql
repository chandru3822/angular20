        ...
        case when p_funnel_id = 3 then
            ...
            from (
                ...
                from brs.project_details pd
                    ...
                    inner join flow.user_position up on (up.user_id = pd.setter_user_id and up.primary_flag is true and up.position_id in (4,5,573,6,73) and up.archived is not true)
