...
BEGIN
  ...
  select concat('{ ',
                '"v_closer_first_name": ', quote_ident(coalesce(v_closer_first_name::text, '')), ','
                  '"v_contact_name": ', quote_ident(coalesce(v_contact_name::text, '')), ','
                  '"v_contact_street": ', quote_ident(coalesce(v_contact_street::text, '')), ','
                  '"v_contact_city": ', quote_ident(coalesce(v_contact_city::text, '')), ','
                  '"v_contact_state": ', quote_ident(coalesce(v_contact_state::text, '')), ','
                  '"v_appt_start_time": ', quote_ident(coalesce(v_appt_start_time::text, '')), ','
                  '"v_appt_end_time": ', quote_ident(coalesce(v_appt_end_time::text, '')), ','
                  '"v_site_survey_start_time": ', quote_ident(coalesce(v_site_survey_start_time::text, '')), ','
                  '"v_system_size": ', quote_ident(coalesce(v_system_size::text, '')), ','
                  '"v_installation_start_time": ', quote_ident(coalesce(v_installation_start_time::text, '')), ','
                  '"v_project_name": ', quote_ident(coalesce(v_project_name::text, '')), ','
                  '"v_project_id": ', quote_ident(coalesce(p_project_id::text, '')), ','
                  '"v_project_phone": ', quote_ident(coalesce(v_project_phone::text, '')),
                ' }')::jsonb into vars;
