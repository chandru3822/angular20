drop FUNCTION if exists brs.insert_setter_commission_on_project(p_project_id bigint);
CREATE OR REPLACE FUNCTION brs.insert_setter_commission_on_project(p_project_id bigint)
    RETURNS void
    LANGUAGE plpgsql
AS
$function$
