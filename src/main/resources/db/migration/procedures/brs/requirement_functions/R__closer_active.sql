...
$BODY$
declare
    v_closer_active boolean;
BEGIN
    v_closer_active = false;

    select true into v_closer_active
    ...
    return case when v_closer_active is null then false else v_closer_active end;
