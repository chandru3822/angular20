CREATE OR REPLACE FUNCTION brs.get_office_lead_allocation_rank(p_postal_code_zone_id integer)
    RETURNS table
            (
                user_id              integer,
...
BEGIN
    return query
        ...
        group by foo1.user_id, foo1.lead_gen_fdc, foo1.self_gen, foo1.average_availability, foo1.score;
END
$BODY$
