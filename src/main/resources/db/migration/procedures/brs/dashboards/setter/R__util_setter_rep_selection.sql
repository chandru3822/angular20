drop function if exists brs.util_setter_rep_selection(p_platform_user_id bigint, p_area_ids json, p_region_ids json, p_district_ids json, p_office_ids json);
  CREATE OR REPLACE FUNCTION brs.util_setter_rep_selection(p_platform_user_id bigint, p_area_ids json, p_region_ids json, p_district_ids json, p_office_ids json)
    RETURNS SETOF json
    LANGUAGE plpgsql
AS
$function$
