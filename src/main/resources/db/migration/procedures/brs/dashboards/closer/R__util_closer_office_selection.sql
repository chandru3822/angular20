drop function if exists brs.util_closer_office_selection(p_platform_user_id bigint, p_area_ids json, p_region_ids json, p_district_ids json, p_permission_override boolean );
CREATE OR REPLACE FUNCTION brs.util_closer_office_selection(p_platform_user_id bigint, p_area_ids json, p_region_ids json, p_district_ids json, p_permission_override boolean DEFAULT false)
    RETURNS SETOF json
    LANGUAGE plpgsql
AS $function$
DECLARE
