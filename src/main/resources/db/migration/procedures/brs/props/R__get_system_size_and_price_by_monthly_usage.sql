...
--   raise notice 'v_federal_tax_incentive_amount_100_cash %',v_federal_tax_incentive_amount_100_cash;
  ...
  return query
    select v_average_production_factor,
           ...
           round(v_net_system_cost_100_offset_low_dealer_fee + v_battery_price),
	       round(v_net_system_cost_100_offset_low_dealer_fee),
           round(v_net_system_cost_85_offset_low_dealer_fee + v_battery_price),
	       round(v_net_system_cost_85_offset_low_dealer_fee),
           round(v_net_system_cost_115_offset_low_dealer_fee + v_battery_price),
	       round(v_net_system_cost_115_offset_low_dealer_fee),
           round(v_net_system_cost_100_offset_low_month_pmt + v_battery_price),
	       round(v_net_system_cost_100_offset_low_month_pmt),
           round(v_net_system_cost_85_offset_low_month_pmt + v_battery_price),
	       round(v_net_system_cost_85_offset_low_month_pmt),
           round(v_net_system_cost_115_offset_low_month_pmt + v_battery_price),
