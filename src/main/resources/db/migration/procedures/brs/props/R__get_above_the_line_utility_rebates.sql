...
--       raise notice ' above the lin erebate = % ',x.rebate;
      ...
      v_above_the_line_rebate_amount = coalesce(v_above_the_line_rebate_amount,0) + coalesce(v_utility_rebate_amount, 0);
  ...
  return query select coalesce(v_above_the_line_rebate_amount, 0), COALESCE(v_rebates, '{}'::jsonb),v_eto_rebate_amount;
END
$BODY$
